...
# note = "School size is measured as follows:<br>Small (less than 200 students)<br>Medium (between 200 and 1000 students)<br>Large (greater than 1000 students)"
# fig.add_annotation(
#     showarrow=False,
#     text=note,
#     font=dict(size=10), 
...
#     y=-0.5
#     )
#fig.update_traces(show_legend = False)fig.show()
    return fig
